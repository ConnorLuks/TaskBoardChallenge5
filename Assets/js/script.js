// // Move? edit name Retrieve tasks and nextId from localStorage
...
//     const fiveDaysFromNow = dayjs().format('YYYY-MM-DD')
//     const taskStatus = task.status;
//     let cardColorClass = '';
//     let dueate = new Date(task.duedate);
//     let today = new Date();
//     let fiveDaysFromNow = new Date();
//     fiveDaysFromNow.setDate(today.getDate() + 5);
//     if (duedate < today) { // card box will be red if near overdue, technically the day of //
//         if (taskStatus === 'done') {
//             cardColorClass = 'card text-dark text-center bg-white mb-3 task-card'
//         } else {
//             cardColorClass = 'card text-dark text-center bg-danger'
//         }
//     } else if (duedate < fiveDaysFromNow) { // card box will be yellow if 5 days from due date //
//         if (taskStatus === 'done') {
//             cardColorClass = 'card text-dark text-center bg-white mb-3 task-card'
//         } else {
//             cardColorClass = 'card text-dark text-center bg-warning mb-3 task-card'
//         }
//     } else {
